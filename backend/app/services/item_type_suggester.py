...
def suggest_item_types(
    ...
    *,
    ...
    if _INIT_ERROR is not None:
        raise RuntimeError("CLIP components unavailable") from _INIT_ERROR
    if _MODEL is None or _PREPROCESS is None or _DEVICE is None or _TOKENS is None or _TEXT_FEATS is None:
        raise RuntimeError("CLIP components not initialized")
